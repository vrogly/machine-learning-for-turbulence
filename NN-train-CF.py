...
np.savetxt(f'{savedir}error-channel-DNS-dudy-and-dudy2-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.txt', [test_loss,c0_std,c2_std] )

filename = f'{savedir}model-channel-DNS-dudy-and-dudy2-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.pth'
torch.save(neural_net, filename)
dump(scaler_dudy2,f'{savedir}model-channel-DNS-dudy-and-dudy2_scaler-dudy2-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.bin')
dump(scaler_dudy,f'{savedir}model-channel-DNS-dudy-and-dudy2_scaler-dudy-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.bin')
...
np.savetxt(f'{savedir}min-max-model-channel-DNS-dudy-and-dudy2-2-hidden-9-yplus-2200-dudy-min-eq.6-scale-with-k-eps-units.txt', [dudy2_min, dudy2_max, dudy_min, dudy_max, c0_min, c0_max, c2_min, c2_max] )
...
plt.ylabel("$y^+$")
plt.legend(loc="best",fontsize=12)
plt.savefig(f'{savedir}c0-dudy2-and-dudy-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.png')
...
plt.legend(loc="best",fontsize=12)
plt.savefig(f'{savedir}c0-dudu2-dudy2-and-dudy-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.png')
...
plt.ylabel(r"$\left(\partial U/\partial y\right)^2$")
plt.legend(loc="best",fontsize=12)
plt.savefig(f'{savedir}c2-dudu2-dudy2-and-dudy-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.png')
...
plt.ylabel("$y^+$")
plt.legend(loc="best",fontsize=12)
plt.savefig(f'{savedir}c2-dudy2-and-dudy-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.png')
...
plt.ylabel("$y^+$")
plt.legend(loc="best",fontsize=12)
plt.savefig(f'{savedir}uu-dudy2-and-dudy-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.png')
...
plt.ylabel("$y^+$")
plt.legend(loc="best",fontsize=12)
plt.savefig(f'{savedir}vv-dudy2-and-dudy-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.png')
...
plt.ylabel("$y^+$")
plt.legend(loc="best",fontsize=12)
plt.savefig(f'{savedir}ww-dudy2-and-dudy-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.png')
...
plt.ylabel("$y^+$")
plt.legend(loc="best",fontsize=12)
plt.savefig(f'{savedir}time-scales-dudy-and-dudy-squared-dudy2-and-dudy-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.png')
...
plt.ylabel("$y^+$")
plt.savefig(f'{savedir}dudy-times-dudy-dudy-and-dudy-squared-dudy2-and-dudy-2-hidden-9-yplus-2200-dudy-min-eq.4e-4-scale-with-k-eps-units.png')
